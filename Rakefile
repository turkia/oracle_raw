...
Jeweler::Tasks.new do |gem|
  ...
  gem.description = %Q{This is a Ruby utility library for interfacing with an Oracle Database using pooled OCI8 connections (http://ruby-oci8.rubyforge.org/en/).}
